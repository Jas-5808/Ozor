...
export function Header() {
    ...
    const [selected, setSelected] = useState({ img: "/icons/uzb.png", label: "UZS", value: "uz" });
                    ...
                    <div className={cn.header_content}>
                        <div className={cn.header_location}>
                            ...
                            <div className={cn.select}>
                                ...
                                >
                                    <img src={selected.img} alt={selected.value} /> {selected.label}
                                </div>
                                {isOpen && (
                                    <ul className={cn.options}>
                                        <p>Язык</p>
                                        <li onClick={() => handleSelect("uz", "/icons/uzb.png", "UZS")}>
                                            UZ <span>Oʻzbek</span>
                                        </li>
                                        <li onClick={() => handleSelect("ru", "/icons/ru.png", "RU")}>
                        ...
                        <div className={cn.header_main}>
                            <div>
                            <a href="/" className={cn.logo}>OZOR</a>
                            ...
                            <ul className={cn.header_link}>
                                {isAuthenticated ? (
                                    <>
                                        <li><a href="#" onClick={(e) => { e.preventDefault(); logout(); }}><img src="/icons/user.svg" alt="" />Выйти</a></li>
                                    </>
                                ) : (
                                    <li><a href="/login"><img src="/icons/user.svg" alt="" />Kirish</a></li>
                                )}
                                <li><a href="#"><img src="/icons/like.svg" alt="" />Saralangan</a></li>
                                <li><a href="#"><img src="/icons/korzinka.svg" alt="" />Savat</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className={cn.menu_container}>
                        <ul className={cn.menu_link}>
                            <li><a href="#"><img src="/icons/home.png" alt="" /></a></li>
                            <li><a href="#"><img src="/icons/catalog.png" alt="" /></a></li>
                            <li><a href="#"><img src="/icons/korzinka2.svg" alt="" /></a></li>
                            <li><a href="#"><img src="/icons/like4.svg" alt="" /></a></li>
                            <li><a href="/login"><img src="/icons/user2.svg" alt="" /></a></li>
                        </ul>
                    </div>
                </div>
            </div>
